...
//1、根据经纬度获取位置详情
export const reqGetPosition = (geohash) => ajax(`/position/${geohash}`);
//2、获取食品分类列表
export const reqGetFoodTypes = () => ajax(`/index_category`);
//3、根据经纬度获取商铺列表
export const reqGetShops = (latitude, longitude) => ajax(`/shops`, {latitude, longitude});
//4、根据经纬度和关键字搜索商铺列表
