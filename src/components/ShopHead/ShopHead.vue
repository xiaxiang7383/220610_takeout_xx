  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="isShowDesc=true">
    ...
    <div class="shop-header-discounts" v-if="shopInfo.supports" @click="isShowSupport=true">
    ...
    <div class="shop-brief-modal" v-show="isShowDesc">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close" @click="isShowDesc=false"></span>
        </div>
      </div>
    ...
    <div class="activity-sheet" v-show="isShowSupport">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" :class="supportClasses[s.type]" v-for="s in shopInfo.supports">
            <span class="content-tag">
